...
<div id = "details">
     ...
     <div class="panel-body">    	
        ...
        <button type="button" onclick="authenticate_user()" class="btn btn-success" style="float:right">Continue</button>
...
<nav class="navbar navbar-inverse" style="height:80px">
  ...
  <div class="container-fluid">
    ...
    <div id="sesison" style="float:right ; margin-top:20px ; margin-right:20px">
      ...
      <p style="float:left ; font-size:15px ; margin-top : 10px; color:white;" id="userName">Logged in as :&nbsp&nbsp<span id="username" style="font-size:15px ; color:white;"><?php session_start(); if(isset($_SESSION)) echo ucfirst($_SESSION['user_name']);?></span></p>
...
// FOR TIMER 
...

        {
...

             {
                ...
                document.getElementById('display').innerHTML = '<div><table class="table" style="margin-left:30px ; font-size:20px"><tr><td><span>Correct : ' + correct + '</span></td><td><span>Incorrect = ' + incorrect + '</span></td></tr><tr><td>Keystrokes : ' + keystrokes + '</td><td>Accuracy : ' + accuracy + '%</td></tr><tr><td colspan = "2"><span><center>Words per minute : ' + wpm +'<td><center></span></tr></div>';
